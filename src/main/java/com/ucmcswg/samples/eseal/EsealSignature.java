...
public class EsealSignature {
    ...
    public JAXBElement<PdfSignatureInfoType> getPdfSignature() {
        ...
        try {
            byte[] backgroundBytes = this.getClass().getClassLoader().getResourceAsStream("/assets/background.jpg").readAllBytes();
        ...
        try {
            byte[] foregroundBytes = this.getClass().getClassLoader().getResourceAsStream("/assets/foreground.jpg").readAllBytes();
